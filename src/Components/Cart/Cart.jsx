                ...
                <MDBRow>
                      ...
                      <MDBCol lg="5" className="px-5 py-4">
                          ...
                          <a href="#!" onClick={handleHome}>
                            ...
                            <p className="mb-5">
                              Enter correct address, Shipping will Start Soon After Your Order Confirmed 
                              <a href="#!"> Know more</a>.
                            </p>
...
<div className='emptycartDiv container'>
  <div className='row'>
    <div className="col-md-4"><img src={require('./funny-4419254_640.png')}alt=""  className='emptycartIMG'/></div>
